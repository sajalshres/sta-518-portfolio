...
- I am working on the Airbnb dataset for Chicago city to process the property listings, neighborhoods, and reviews. I want to create a function that can scrape the data for multiple cities on demand. Scraping data would allow me to get updated data in my project. As a stretch goal, I also want to save the scraped data into a database application like MongoDB or PostGreSQL.
